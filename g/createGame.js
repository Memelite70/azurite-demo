...
<html lang="en">
  ...
  <script src="/js/misc.js"></script>
    ...
    <script src="/js/games-navigation.js"></script>
  ...
  <body>
    ...
    <script src="/js/app.js"></script>
     <div class="topnavbar">
     <span onclick="window.location.href='/'"><img class="logoTop" src="/azurite-gem.png"></span>
      <div class="topnavitem marginright20px">
        <a class="topnavtext" href="/games">Games</a>
      </div>
      <div class="topnavitem">
        <a class="topnavtext" href="/">Home</a>
      </div>
    </div>
    <div class="main">
      <center>
        <div class="gamecont">
          <div class="inline">
            <iframe class="gig" src="https://neongames.io/intermediary.html?game=/verticalad.html"></iframe>
          </div>
          <div class="gameframecontainer" id="frame">
            <iframe src="/loader.html?game=${game.url}&img=${game.image}&name=${game.title}" id="game_iframe" class="game_iframe"></iframe>
            <div class="gameUIbar">
              <h1 id="gmsName" class="gmsName">${game.title}</h1>
              <span style="float: right;" class="gamesicon inline" onclick="openFullscreen('game_iframe');">
                <img class="gameUIbutton" src="/svg/ui/fullscreen.svg">
              </span>
            </div>
          </div>
          <div class="inline">
  ...
  fs.writeFileSync(`/games4.2/${fileName}`, fileContent.trim());
});
